...
const ShowDate: React.FC<Props> = ({ style, selectDate, defaultValue, onPress, name }) => {
  ...
  return (
    <>
      <TouchableOpacity
        ...
        style={[globalStyles.flexRow, { gap: rs(5),backgroundColor:colors.white }, style]}>
        ...
        <Text
          ...
          {date ? momentTimezone(date).format('MMMM   YYYY') : trans('Select Date')}
        </Text>
      </TouchableOpacity>
