...
const AddVisitType: React.FC<{onChange: (value: any) => void}> = ({
  onChange,
}) => {
  ...
  const handlePress = async () => {
    if (value.current) {
      setLoading(true);
      const result = await frequentVisitService.createType({
        name: value.current,
      });
