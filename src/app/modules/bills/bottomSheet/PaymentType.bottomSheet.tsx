...
const PaymentType: React.FC<{
  ...
  const handleChange = (item: any) => {
    onChange && onChange(item, 'paymentType');
  ...
  const getDataHandler = async (query: any, success: any) => {
    const result = await paymentService.typesList();
    console.log('getDataHandler PaymentType.bottomsheet:', result?.body.list);
    success({ ...result, body: { list: result?.body.list } });
  };
