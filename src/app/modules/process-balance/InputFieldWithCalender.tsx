...
import DateTimePicker from '../../components/core/DateTimePicker.core.component';
      ...
      <View style={[{ marginBottom: rs(13) }, style]}>
        ...
        >
          <Text
            ...
            numberOfLines={1}
          >
            {date ? momentTimezone(date).format('MM-yyyy') : placeholder}
          </Text>
          <CalenderIcon />
        </TouchableOpacity>
      </View>
      {show && <DateTimePicker onChange={dateChange} value={date || new Date()}
