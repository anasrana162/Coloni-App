...
import assistsReportService from '../../services/features/assistsReport/assistsReport.service';
import {useTranslation} from 'react-i18next';
const AssistsReports = () => {
  ...
  const onPressConfirm = async () => {
    setShowModal(false);
    await assistsReportService.fetch(
    ...
    <Container>
      ...
      {showModal && (
        <ConfirmationModal
          ...
          para={trans(`Download the Assist report from the private company?`)}
