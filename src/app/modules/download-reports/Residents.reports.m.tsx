...
import residentReportService from '../../services/features/residentReport/residentReport.service';
import {useTranslation} from 'react-i18next';
const ResidentsReports = () => {
  ...
  const onPressConfirm = async () => {
    setShowModal(false);
    await residentReportService.fetch(
    ...
    <Container>
      ...
      {showModal && (
        <ConfirmationModal
          ...
          para={trans(`Download the Resident report from the private company?`)}
